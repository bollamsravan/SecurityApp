...
public class SecurityEdit extends AppCompatActivity {
    ...
    private static final String TAG="SecurityEdit";
    ...
    private void update() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(SecurityEdit.this);
